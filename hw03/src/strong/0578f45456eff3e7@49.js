...
function _taiwan(taiwanMap) {
  return (
    taiwanMap(800, 600, -0.0, -0.6, 8000)
  )
}

function _taiwanMap(d3, topojson, tw, DOM, bgColor, strokeColor, strokeOpacity, minidata) {
  return (
...
function _LivePlace(userdata) {
  return (
    Object.keys(userdata[0])[0]
  )
}

function _LivePlace_column(userdata, LivePlace) {
  return (
    userdata.map(row => row[LivePlace])
  )
}

function _LivePlace_uniqueValues(LivePlace_column) {
  return (
...
function _minidata(LivePlace_counts) {
  return (
